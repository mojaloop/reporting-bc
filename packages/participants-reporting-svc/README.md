# Reporting BC - Participants Reporting Service
...
```bash
npm run modules/participants-reporting-svc start
```
...
| SVC_CLIENT_ID        | Service client ID                 | reporting-bc-participants-reporting-svc              |
| SVC_CLIENT_SECRET    | Service client secret             | superServiceSecret     |
| SVC_DEFAULT_HTTP_PORT                 | Default HTTP port for the service                  | 5002  |
